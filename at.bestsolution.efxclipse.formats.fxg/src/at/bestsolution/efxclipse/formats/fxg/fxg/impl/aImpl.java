 ...
 * <ul>
 *   <li>{@link at.bestsolution.efxclipse.formats.fxg.fxg.impl.aImpl#get_children <em>children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class aImpl extends EObjectImpl implements a {
	...
	public EList<RichTextContent> get_children() {
		if (_children == null) {
			_children = new EObjectContainmentEList<RichTextContent>(RichTextContent.class, this, FxgPackage.A__CHILDREN);
		}
		return _children;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == RichTextContentContainer.class) {
			switch (derivedFeatureID) {
				case FxgPackage.A__CHILDREN: return FxgPackage.RICH_TEXT_CONTENT_CONTAINER__CHILDREN;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == RichTextContentContainer.class) {
			switch (baseFeatureID) {
				case FxgPackage.RICH_TEXT_CONTENT_CONTAINER__CHILDREN: return FxgPackage.A__CHILDREN;
				default: return -1;
			}
		}
