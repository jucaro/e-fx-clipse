...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Linear Gradient Stroke</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link at.bestsolution.efxclipse.formats.fxg.fxg.impl.LinearGradientStrokeImpl#get_children <em>children</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.fxg.fxg.impl.LinearGradientStrokeImpl#getX <em>X</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.fxg.fxg.impl.LinearGradientStrokeImpl#getY <em>Y</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.fxg.fxg.impl.LinearGradientStrokeImpl#getScaleX <em>Scale X</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.fxg.fxg.impl.LinearGradientStrokeImpl#getRotation <em>Rotation</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.fxg.fxg.impl.LinearGradientStrokeImpl#getSpreadMethod <em>Spread Method</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.fxg.fxg.impl.LinearGradientStrokeImpl#getInterpolationMethod <em>Interpolation Method</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.fxg.fxg.impl.LinearGradientStrokeImpl#getScaleMode <em>Scale Mode</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.fxg.fxg.impl.LinearGradientStrokeImpl#getCaps <em>Caps</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.fxg.fxg.impl.LinearGradientStrokeImpl#getJoints <em>Joints</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.fxg.fxg.impl.LinearGradientStrokeImpl#getMiterLimit <em>Miter Limit</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.fxg.fxg.impl.LinearGradientStrokeImpl#getWeight <em>Weight</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.fxg.fxg.impl.LinearGradientStrokeImpl#getPixelHinting <em>Pixel Hinting</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.fxg.fxg.impl.LinearGradientStrokeImpl#getMatrix <em>Matrix</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LinearGradientStrokeImpl extends EObjectImpl implements LinearGradientStroke {
	/**
	 ...
	 * @generated
	 */
	protected LinearGradientStrokeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FxgPackage.Literals.LINEAR_GRADIENT_STROKE;
	}
	...
	public EList<GradientEntry> get_children() {
		if (_children == null) {
			_children = new EObjectContainmentEList<GradientEntry>(FXGElement.class, this, FxgPackage.LINEAR_GRADIENT_STROKE__CHILDREN);
		}
		return _children;
	}
	...
	public void setX(Double newX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FxgPackage.LINEAR_GRADIENT_STROKE__X, oldX, x));
	}
	...
	public void setY(Double newY) {
		...
		y = newY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FxgPackage.LINEAR_GRADIENT_STROKE__Y, oldY, y));
	}
	...
	public void setScaleX(Double newScaleX) {
		...
		scaleX = newScaleX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FxgPackage.LINEAR_GRADIENT_STROKE__SCALE_X, oldScaleX, scaleX));
	}
	...
	public void setRotation(Double newRotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FxgPackage.LINEAR_GRADIENT_STROKE__ROTATION, oldRotation, rotation));
	}
	...
	public void setScaleMode(ScaleMode newScaleMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FxgPackage.LINEAR_GRADIENT_STROKE__SCALE_MODE, oldScaleMode, scaleMode));
	}
	...
	public void setCaps(Cap newCaps) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FxgPackage.LINEAR_GRADIENT_STROKE__CAPS, oldCaps, caps));
	}
	...
	public void setJoints(Joint newJoints) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FxgPackage.LINEAR_GRADIENT_STROKE__JOINTS, oldJoints, joints));
	}
	...
	public void setMiterLimit(Double newMiterLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FxgPackage.LINEAR_GRADIENT_STROKE__MITER_LIMIT, oldMiterLimit, miterLimit));
	}
	...
	public void setWeight(Double newWeight) {
		...
		weight = newWeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FxgPackage.LINEAR_GRADIENT_STROKE__WEIGHT, oldWeight, weight));
	}
	...
	public void setPixelHinting(Boolean newPixelHinting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FxgPackage.LINEAR_GRADIENT_STROKE__PIXEL_HINTING, oldPixelHinting, pixelHinting));
	}
	...
	public NotificationChain basicSetMatrix(Matrix newMatrix, NotificationChain msgs) {
		...
		matrix = newMatrix;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FxgPackage.LINEAR_GRADIENT_STROKE__MATRIX, oldMatrix, newMatrix);
	...
	public void setMatrix(Matrix newMatrix) {
		if (newMatrix != matrix) {
			...
			if (matrix != null)
				msgs = ((InternalEObject)matrix).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FxgPackage.LINEAR_GRADIENT_STROKE__MATRIX, null, msgs);
			if (newMatrix != null)
				msgs = ((InternalEObject)newMatrix).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FxgPackage.LINEAR_GRADIENT_STROKE__MATRIX, null, msgs);
			msgs = basicSetMatrix(newMatrix, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FxgPackage.LINEAR_GRADIENT_STROKE__MATRIX, newMatrix, newMatrix));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FxgPackage.LINEAR_GRADIENT_STROKE__CHILDREN:
				return ((InternalEList<?>)get_children()).basicRemove(otherEnd, msgs);
			case FxgPackage.LINEAR_GRADIENT_STROKE__MATRIX:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FxgPackage.LINEAR_GRADIENT_STROKE__CHILDREN:
				return get_children();
			case FxgPackage.LINEAR_GRADIENT_STROKE__X:
				return getX();
			case FxgPackage.LINEAR_GRADIENT_STROKE__Y:
				return getY();
			case FxgPackage.LINEAR_GRADIENT_STROKE__SCALE_X:
				return getScaleX();
			case FxgPackage.LINEAR_GRADIENT_STROKE__ROTATION:
				return getRotation();
			case FxgPackage.LINEAR_GRADIENT_STROKE__SPREAD_METHOD:
				return getSpreadMethod();
			case FxgPackage.LINEAR_GRADIENT_STROKE__INTERPOLATION_METHOD:
				return getInterpolationMethod();
			case FxgPackage.LINEAR_GRADIENT_STROKE__SCALE_MODE:
				return getScaleMode();
			case FxgPackage.LINEAR_GRADIENT_STROKE__CAPS:
				return getCaps();
			case FxgPackage.LINEAR_GRADIENT_STROKE__JOINTS:
				return getJoints();
			case FxgPackage.LINEAR_GRADIENT_STROKE__MITER_LIMIT:
				return getMiterLimit();
			case FxgPackage.LINEAR_GRADIENT_STROKE__WEIGHT:
				return getWeight();
			case FxgPackage.LINEAR_GRADIENT_STROKE__PIXEL_HINTING:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ContainerElement.class) {
			switch (derivedFeatureID) {
				case FxgPackage.LINEAR_GRADIENT_STROKE__CHILDREN: return FxgPackage.CONTAINER_ELEMENT__CHILDREN;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ContainerElement.class) {
			switch (baseFeatureID) {
				case FxgPackage.CONTAINER_ELEMENT__CHILDREN: return FxgPackage.LINEAR_GRADIENT_STROKE__CHILDREN;
				default: return -1;
			}
		}
