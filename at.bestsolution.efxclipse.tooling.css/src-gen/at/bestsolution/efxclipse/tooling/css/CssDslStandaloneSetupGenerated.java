...
public class CssDslStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new at.bestsolution.efxclipse.tooling.css.CssDslRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.bestsolution.at/efxclipse/tooling/css/CssDsl")) {
		EPackage.Registry.INSTANCE.put("http://www.bestsolution.at/efxclipse/tooling/css/CssDsl", at.bestsolution.efxclipse.tooling.css.cssDsl.CssDslPackage.eINSTANCE);
	}
