 ...
 *   <li>{@link at.bestsolution.efxclipse.tooling.fxgraph.fXGraph.Define#getIncludeElement <em>Include Element</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Define extends EObject
{
   ...
   * @see at.bestsolution.efxclipse.tooling.fxgraph.fXGraph.FXGraphPackage#getDefine_IncludeElement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link at.bestsolution.efxclipse.tooling.fxgraph.fXGraph.Define#getIncludeElement <em>Include Element</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
