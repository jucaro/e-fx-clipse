		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getValuePropertyAccess().getAlternatives_1(), "rule__ValueProperty__Alternatives_1");
					...
					put(grammarAccess.getListPropertyAccess().getGroup_2(), "rule__ListProperty__Group_2__0");
					put(grammarAccess.getValuePropertyAccess().getGroup_1_0(), "rule__ValueProperty__Group_1_0__0");
					put(grammarAccess.getReferencePropertyAccess().getGroup(), "rule__ReferenceProperty__Group__0");
					put(grammarAccess.getIncludePropertyAccess().getGroup(), "rule__IncludeProperty__Group__0");
					...
					put(grammarAccess.getModelAccess().getRootNodeAssignment_1(), "rule__Model__RootNodeAssignment_1");
					...
					put(grammarAccess.getListPropertyAccess().getValueAssignment_1(), "rule__ListProperty__ValueAssignment_1");
					put(grammarAccess.getListPropertyAccess().getValueAssignment_2_1(), "rule__ListProperty__ValueAssignment_2_1");
					put(grammarAccess.getValuePropertyAccess().getStringValueAssignment_0(), "rule__ValueProperty__StringValueAssignment_0");
					put(grammarAccess.getValuePropertyAccess().getNegativeAssignment_1_0_0(), "rule__ValueProperty__NegativeAssignment_1_0_0");
					put(grammarAccess.getValuePropertyAccess().getRealValueAssignment_1_0_1(), "rule__ValueProperty__RealValueAssignment_1_0_1");
					put(grammarAccess.getValuePropertyAccess().getIntValueAssignment_1_1(), "rule__ValueProperty__IntValueAssignment_1_1");
					put(grammarAccess.getReferencePropertyAccess().getReferenceAssignment_1(), "rule__ReferenceProperty__ReferenceAssignment_1");
					put(grammarAccess.getIncludePropertyAccess().getSourceAssignment_1(), "rule__IncludeProperty__SourceAssignment_1");
