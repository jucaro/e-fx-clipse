...
public class SvgAltGlyphRefElementImpl extends EObjectImpl implements SvgAltGlyphRefElement {
	...
	public SvgElement getResolvedInstance() {
		if (resolvedInstance != null && resolvedInstance.eIsProxy()) {
			...
			if (resolvedInstance != oldResolvedInstance) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SvgPackage.SVG_ALT_GLYPH_REF_ELEMENT__RESOLVED_INSTANCE, oldResolvedInstance, resolvedInstance));
			}
		}
	...
	public void setResolvedInstance(SvgElement newResolvedInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_ALT_GLYPH_REF_ELEMENT__RESOLVED_INSTANCE, oldResolvedInstance, resolvedInstance));
	}
