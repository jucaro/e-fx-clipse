package at.bestsolution.efxclipse.tooling.fxml2.serializer;
...
public class AbstractFXMLSemanticSequencer extends AbstractSemanticSequencer {

	@Inject
	protected FXMLGrammarAccess grammarAccess;
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == FXMLPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case FXMLPackage.CLASS_DEFINITION:
				if(context == grammarAccess.getClassDefinitionRule()) {
					sequence_ClassDefinition(context, (ClassDefinition) semanticObject); 
					return; 
				}
				else break;
			case FXMLPackage.MODEL:
				if(context == grammarAccess.getModelRule()) {
					sequence_Model(context, (Model) semanticObject); 
					return; 
				}
				else break;
			case FXMLPackage.PROCESSING_INSTRUCTION:
			...
			case FXMLPackage.PROPERTY_ATTRIBUTE_DEFINITION:
				if(context == grammarAccess.getPropertyAttributeDefinitionRule()) {
					sequence_PropertyAttributeDefinition(context, (PropertyAttributeDefinition) semanticObject); 
					return; 
				}
				else break;
			case FXMLPackage.PROPERTY_DEFINITION:
	...
	protected void sequence_ProcessingInstruction(EObject context, ProcessingInstruction semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, FXMLPackage.Literals.PROCESSING_INSTRUCTION__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, FXMLPackage.Literals.PROCESSING_INSTRUCTION__TYPE));
			if(transientValues.isValueTransient(semanticObject, FXMLPackage.Literals.PROCESSING_INSTRUCTION__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, FXMLPackage.Literals.PROCESSING_INSTRUCTION__VALUE));
		}
		...
		feeder.accept(grammarAccess.getProcessingInstructionAccess().getValueQualifiedNameWithWildCardParserRuleCall_2_0(), semanticObject.getValue());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_PropertyAttributeDefinition(EObject context, PropertyAttributeDefinition semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
