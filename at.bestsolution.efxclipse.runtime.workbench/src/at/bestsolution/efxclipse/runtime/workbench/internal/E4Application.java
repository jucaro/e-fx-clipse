	...
	public static IEclipseContext createDefaultContext() {
		...
		appContext.set(EPartService.PART_SERVICE_ROOT, new ContextFunction() {
			private void log() {
				...
				statusReporter.report(new Status(IStatus.ERROR, WorkbenchJFXActivator.PI_RENDERERS, "Internal error, please post the trace to bug 315270", new Exception()), StatusReporter.LOG);
			}
