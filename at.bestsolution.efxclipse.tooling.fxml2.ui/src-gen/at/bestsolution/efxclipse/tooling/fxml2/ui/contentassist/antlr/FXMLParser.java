...
* generated by Xtext
*/
package at.bestsolution.efxclipse.tooling.fxml2.ui.contentassist.antlr;
...
public class FXMLParser extends AbstractContentAssistParser {
	...
	@Override
	protected at.bestsolution.efxclipse.tooling.fxml2.ui.contentassist.antlr.internal.InternalFXMLParser createParser() {
		at.bestsolution.efxclipse.tooling.fxml2.ui.contentassist.antlr.internal.InternalFXMLParser result = new at.bestsolution.efxclipse.tooling.fxml2.ui.contentassist.antlr.internal.InternalFXMLParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getClassDefinitionAccess().getAlternatives(), "rule__ClassDefinition__Alternatives");
					...
					put(grammarAccess.getClassDefinitionAccess().getGroup_0(), "rule__ClassDefinition__Group_0__0");
					put(grammarAccess.getClassDefinitionAccess().getGroup_1(), "rule__ClassDefinition__Group_1__0");
					put(grammarAccess.getPropertyAttributeDefinitionAccess().getGroup(), "rule__PropertyAttributeDefinition__Group__0");
					put(grammarAccess.getPropertyAttributeDefinitionAccess().getGroup_0(), "rule__PropertyAttributeDefinition__Group_0__0");
					...
					put(grammarAccess.getModelAccess().getXmlDecAssignment_0(), "rule__Model__XmlDecAssignment_0");
					put(grammarAccess.getModelAccess().getCommentsAssignment_1(), "rule__Model__CommentsAssignment_1");
					put(grammarAccess.getModelAccess().getImportsAssignment_2(), "rule__Model__ImportsAssignment_2");
					put(grammarAccess.getModelAccess().getCommentsAssignment_3(), "rule__Model__CommentsAssignment_3");
					put(grammarAccess.getModelAccess().getRootAssignment_4(), "rule__Model__RootAssignment_4");
					put(grammarAccess.getProcessingInstructionAccess().getTypeAssignment_1(), "rule__ProcessingInstruction__TypeAssignment_1");
					put(grammarAccess.getProcessingInstructionAccess().getValueAssignment_2(), "rule__ProcessingInstruction__ValueAssignment_2");
					put(grammarAccess.getClassDefinitionAccess().getNameAssignment_0_1(), "rule__ClassDefinition__NameAssignment_0_1");
					put(grammarAccess.getClassDefinitionAccess().getAttributesAssignment_0_2(), "rule__ClassDefinition__AttributesAssignment_0_2");
					put(grammarAccess.getClassDefinitionAccess().getChildrenAssignment_0_4(), "rule__ClassDefinition__ChildrenAssignment_0_4");
					put(grammarAccess.getClassDefinitionAccess().getEndnameAssignment_0_6(), "rule__ClassDefinition__EndnameAssignment_0_6");
					put(grammarAccess.getClassDefinitionAccess().getNameAssignment_1_1(), "rule__ClassDefinition__NameAssignment_1_1");
					put(grammarAccess.getClassDefinitionAccess().getAttributesAssignment_1_2(), "rule__ClassDefinition__AttributesAssignment_1_2");
					put(grammarAccess.getPropertyAttributeDefinitionAccess().getNamespaceAssignment_0_0(), "rule__PropertyAttributeDefinition__NamespaceAssignment_0_0");
					put(grammarAccess.getPropertyAttributeDefinitionAccess().getNameAssignment_1(), "rule__PropertyAttributeDefinition__NameAssignment_1");
					put(grammarAccess.getPropertyAttributeDefinitionAccess().getValueAssignment_3(), "rule__PropertyAttributeDefinition__ValueAssignment_3");
					put(grammarAccess.getPropertyDefinitionAccess().getNameAssignment_1(), "rule__PropertyDefinition__NameAssignment_1");
					put(grammarAccess.getPropertyDefinitionAccess().getChildrenAssignment_3_0(), "rule__PropertyDefinition__ChildrenAssignment_3_0");
					put(grammarAccess.getPropertyDefinitionAccess().getSimpleValueAssignment_3_1(), "rule__PropertyDefinition__SimpleValueAssignment_3_1");
					put(grammarAccess.getPropertyDefinitionAccess().getEndnameAssignment_5(), "rule__PropertyDefinition__EndnameAssignment_5");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			at.bestsolution.efxclipse.tooling.fxml2.ui.contentassist.antlr.internal.InternalFXMLParser typedParser = (at.bestsolution.efxclipse.tooling.fxml2.ui.contentassist.antlr.internal.InternalFXMLParser) parser;
