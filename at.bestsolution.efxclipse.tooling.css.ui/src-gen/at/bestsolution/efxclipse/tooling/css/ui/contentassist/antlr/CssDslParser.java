		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSimple_selectorAccess().getAlternatives_0_1(), "rule__Simple_selector__Alternatives_0_1");
					put(grammarAccess.getSimple_selectorAccess().getAlternatives_1(), "rule__Simple_selector__Alternatives_1");
					...
					put(grammarAccess.getSimple_selectorAccess().getIdAssignment_0_1_0(), "rule__Simple_selector__IdAssignment_0_1_0");
					put(grammarAccess.getSimple_selectorAccess().getClassAssignment_0_1_1(), "rule__Simple_selector__ClassAssignment_0_1_1");
					put(grammarAccess.getSimple_selectorAccess().getAttribAssignment_0_1_2(), "rule__Simple_selector__AttribAssignment_0_1_2");
					put(grammarAccess.getSimple_selectorAccess().getPseudoclassesAssignment_0_1_3(), "rule__Simple_selector__PseudoclassesAssignment_0_1_3");
