		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getElementAccess().getAlternatives_4_3_0(), "rule__Element__Alternatives_4_3_0");
					put(grammarAccess.getElementAccess().getAlternatives_4_3_1_1(), "rule__Element__Alternatives_4_3_1_1");
					put(grammarAccess.getScriptAccess().getAlternatives_1(), "rule__Script__Alternatives_1");
					...
					put(grammarAccess.getElementAccess().getGroup_4_1_2(), "rule__Element__Group_4_1_2__0");
					put(grammarAccess.getElementAccess().getGroup_4_3(), "rule__Element__Group_4_3__0");
					put(grammarAccess.getElementAccess().getGroup_4_3_1(), "rule__Element__Group_4_3_1__0");
					...
					put(grammarAccess.getModelAccess().getLanguageAssignment_1(), "rule__Model__LanguageAssignment_1");
					put(grammarAccess.getModelAccess().getRootNodeAssignment_2(), "rule__Model__RootNodeAssignment_2");
					put(grammarAccess.getLanguageAccess().getLanguageAssignment_1(), "rule__Language__LanguageAssignment_1");
					put(grammarAccess.getImportAccess().getImportedNamespaceAssignment_1(), "rule__Import__ImportedNamespaceAssignment_1");
					put(grammarAccess.getElementAccess().getTypeAssignment_0(), "rule__Element__TypeAssignment_0");
					put(grammarAccess.getElementAccess().getValueAssignment_1_1_0(), "rule__Element__ValueAssignment_1_1_0");
					put(grammarAccess.getElementAccess().getFactoryAssignment_1_1_1_1(), "rule__Element__FactoryAssignment_1_1_1_1");
					put(grammarAccess.getElementAccess().getNameAssignment_2_1(), "rule__Element__NameAssignment_2_1");
					put(grammarAccess.getElementAccess().getControllerAssignment_3_1(), "rule__Element__ControllerAssignment_3_1");
					put(grammarAccess.getElementAccess().getDefinesAssignment_4_1_1(), "rule__Element__DefinesAssignment_4_1_1");
					put(grammarAccess.getElementAccess().getDefinesAssignment_4_1_2_1(), "rule__Element__DefinesAssignment_4_1_2_1");
					put(grammarAccess.getElementAccess().getScriptsAssignment_4_2(), "rule__Element__ScriptsAssignment_4_2");
					put(grammarAccess.getElementAccess().getPropertiesAssignment_4_3_0_0(), "rule__Element__PropertiesAssignment_4_3_0_0");
					put(grammarAccess.getElementAccess().getStaticPropertiesAssignment_4_3_0_1(), "rule__Element__StaticPropertiesAssignment_4_3_0_1");
					put(grammarAccess.getElementAccess().getPropertiesAssignment_4_3_1_1_0(), "rule__Element__PropertiesAssignment_4_3_1_1_0");
					put(grammarAccess.getElementAccess().getStaticPropertiesAssignment_4_3_1_1_1(), "rule__Element__StaticPropertiesAssignment_4_3_1_1_1");
					put(grammarAccess.getDefineAccess().getElementAssignment(), "rule__Define__ElementAssignment");
					put(grammarAccess.getScriptAccess().getSourceAssignment_1_0(), "rule__Script__SourceAssignment_1_0");
					put(grammarAccess.getScriptAccess().getSourcecodeAssignment_1_1(), "rule__Script__SourcecodeAssignment_1_1");
