 ...
 * <ul>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getId <em>Id</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getXml__base <em>Xml base</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getXml__lang <em>Xml lang</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getXml__space <em>Xml space</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getAlignment_baseline <em>Alignment baseline</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getBaseline_shift <em>Baseline shift</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getClip <em>Clip</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getClip_path <em>Clip path</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getClip_rule <em>Clip rule</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getColor <em>Color</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getColor_interpolation <em>Color interpolation</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getColor_interpolation_filters <em>Color interpolation filters</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getColor_profile <em>Color profile</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getColor_rendering <em>Color rendering</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getCursor <em>Cursor</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getDirection <em>Direction</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getDisplay <em>Display</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getDominant_baseline <em>Dominant baseline</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getEnable_background <em>Enable background</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getFill <em>Fill</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getFill_opacity <em>Fill opacity</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getFill_rule <em>Fill rule</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getFilter <em>Filter</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getFlood_color <em>Flood color</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getFlood_opacity <em>Flood opacity</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getFont_family <em>Font family</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getFont_size <em>Font size</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getFont_size_adjust <em>Font size adjust</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getFont_stretch <em>Font stretch</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getFont_style <em>Font style</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getFont_variant <em>Font variant</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getFont_weight <em>Font weight</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getGlyph_orientation_horizontal <em>Glyph orientation horizontal</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getGlyph_orientation_vertical <em>Glyph orientation vertical</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getImage_rendering <em>Image rendering</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getKerning <em>Kerning</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getLetter_spacing <em>Letter spacing</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getLighting_color <em>Lighting color</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getMarker_end <em>Marker end</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getMarker_mid <em>Marker mid</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getMarker_start <em>Marker start</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getMasks <em>Masks</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getOpacity <em>Opacity</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getOverflow <em>Overflow</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getPointer_events <em>Pointer events</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getShape_rendering <em>Shape rendering</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getStop_color <em>Stop color</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getStop_opacity <em>Stop opacity</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getStroke <em>Stroke</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getStroke_dasharray <em>Stroke dasharray</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getStroke_dashoffset <em>Stroke dashoffset</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getStroke_linecap <em>Stroke linecap</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getStroke_linejoin <em>Stroke linejoin</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getStroke_miterlimit <em>Stroke miterlimit</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getStroke_opacity <em>Stroke opacity</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getStroke_width <em>Stroke width</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getText_anchor <em>Text anchor</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getText_decoration <em>Text decoration</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getText_rendering <em>Text rendering</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getUnicode_bidi <em>Unicode bidi</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getWord_spacing <em>Word spacing</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getWriting_mode <em>Writing mode</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeFuncRElementImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
