 ...
 * <ul>
 *   <li>{@link at.bestsolution.efxclipse.formats.fxg.fxg.impl.divImpl#get_children <em>children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class divImpl extends EObjectImpl implements div {
	/**
	...
	protected EClass eStaticClass() {
		return FxgPackage.Literals.DIV;
	}
	...
	public EList<RichTextContent> get_children() {
		if (_children == null) {
			_children = new EObjectContainmentEList<RichTextContent>(RichTextContent.class, this, FxgPackage.DIV__CHILDREN);
		}
		return _children;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == RichTextContentContainer.class) {
			switch (derivedFeatureID) {
				case FxgPackage.DIV__CHILDREN: return FxgPackage.RICH_TEXT_CONTENT_CONTAINER__CHILDREN;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == RichTextContentContainer.class) {
			switch (baseFeatureID) {
				case FxgPackage.RICH_TEXT_CONTENT_CONTAINER__CHILDREN: return FxgPackage.DIV__CHILDREN;
				default: return -1;
			}
		}
