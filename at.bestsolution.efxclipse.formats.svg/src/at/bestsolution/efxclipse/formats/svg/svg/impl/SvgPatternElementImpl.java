	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ContainerElement.class) {
			switch (derivedFeatureID) {
				case SvgPackage.SVG_PATTERN_ELEMENT__CHILDREN: return SvgPackage.CONTAINER_ELEMENT__CHILDREN;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ContainerElement.class) {
			switch (baseFeatureID) {
				case SvgPackage.CONTAINER_ELEMENT__CHILDREN: return SvgPackage.SVG_PATTERN_ELEMENT__CHILDREN;
				default: return -1;
			}
		}
		if (baseClass == ConditionalProcessingAttributes.class) {
