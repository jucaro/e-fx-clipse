 ...
 * <!-- end-user-doc -->
 * @see at.bestsolution.efxclipse.formats.fxg.fxg.FxgPackage#getAlignmentBaseline()
 * @model
 * @generated
 */
public enum AlignmentBaseline implements Enumerator {
	/**
	...
	/**
	 * The '<em><b>Use Dominant Baseline</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #USE_DOMINANT_BASELINE_VALUE
	 * @generated
	 * @ordered
	 */
	USE_DOMINANT_BASELINE(7, "useDominantBaseline", "useDominantBaseline");
	...
	/**
	 * The '<em><b>Use Dominant Baseline</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Use Dominant Baseline</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #USE_DOMINANT_BASELINE
	 * @model name="useDominantBaseline"
	 * @generated
	 * @ordered
	 */
	public static final int USE_DOMINANT_BASELINE_VALUE = 7;
	 ...
	 * @generated
	 */
	private static final AlignmentBaseline[] VALUES_ARRAY =
	 ...
	 * @generated
	 */
	public static final List<AlignmentBaseline> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static AlignmentBaseline get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			AlignmentBaseline result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static AlignmentBaseline getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			AlignmentBaseline result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static AlignmentBaseline get(int value) {
		switch (value) {
			...
			case USE_DOMINANT_BASELINE_VALUE: return USE_DOMINANT_BASELINE;
		}
		return null;
	}
	 ...
	 * @generated
	 */
	private AlignmentBaseline(int value, String name, String literal) {
		this.value = value;
		this.name = name;
