 ...
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeSpotLightImpl#getChildren <em>Children</em>}</li>
...
public class SvgFeSpotLightImpl extends EObjectImpl implements SvgFeSpotLight {
	...
	public EList<SvgElement> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<SvgElement>(SvgElement.class, this, SvgPackage.SVG_FE_SPOT_LIGHT__CHILDREN);
		}
		return children;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SvgPackage.SVG_FE_SPOT_LIGHT__CHILDREN:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ContentElement.class) {
			switch (derivedFeatureID) {
				case SvgPackage.SVG_FE_SPOT_LIGHT__CHILDREN: return SvgPackage.CONTENT_ELEMENT__CHILDREN;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ContentElement.class) {
			switch (baseFeatureID) {
				case SvgPackage.CONTENT_ELEMENT__CHILDREN: return SvgPackage.SVG_FE_SPOT_LIGHT__CHILDREN;
				default: return -1;
			}
		}
