 ...
 * <ul>
 *   <li>{@link at.bestsolution.efxclipse.tooling.css.cssDsl.impl.HSBColorImpl#getHue <em>Hue</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.tooling.css.cssDsl.impl.HSBColorImpl#getSaturation <em>Saturation</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.tooling.css.cssDsl.impl.HSBColorImpl#getBrightness <em>Brightness</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.tooling.css.cssDsl.impl.HSBColorImpl#getAlpha <em>Alpha</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HSBColorImpl extends ColorImpl implements HSBColor
{
  /**
  ...
  {
    return CssDslPackage.Literals.HSB_COLOR;
  }
  ...
  public void setHue(String newHue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CssDslPackage.HSB_COLOR__HUE, oldHue, hue));
  }
  ...
  public void setSaturation(String newSaturation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CssDslPackage.HSB_COLOR__SATURATION, oldSaturation, saturation));
  }
  ...
  public void setBrightness(String newBrightness)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CssDslPackage.HSB_COLOR__BRIGHTNESS, oldBrightness, brightness));
  }
  ...
  public void setAlpha(String newAlpha)
  {
    ...
    alpha = newAlpha;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CssDslPackage.HSB_COLOR__ALPHA, oldAlpha, alpha));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CssDslPackage.HSB_COLOR__HUE:
        return getHue();
      case CssDslPackage.HSB_COLOR__SATURATION:
        return getSaturation();
      case CssDslPackage.HSB_COLOR__BRIGHTNESS:
        return getBrightness();
      case CssDslPackage.HSB_COLOR__ALPHA:
        return getAlpha();
    }
