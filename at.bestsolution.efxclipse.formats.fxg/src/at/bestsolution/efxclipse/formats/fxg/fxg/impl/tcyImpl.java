...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>tcy</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link at.bestsolution.efxclipse.formats.fxg.fxg.impl.tcyImpl#get_children <em>children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class tcyImpl extends EObjectImpl implements tcy {
	/**
	...
	protected EClass eStaticClass() {
		return FxgPackage.Literals.TCY;
	}
	...
	public EList<RichTextContent> get_children() {
		if (_children == null) {
			_children = new EObjectContainmentEList<RichTextContent>(RichTextContent.class, this, FxgPackage.TCY__CHILDREN);
		}
		return _children;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == RichTextContentContainer.class) {
			switch (derivedFeatureID) {
				case FxgPackage.TCY__CHILDREN: return FxgPackage.RICH_TEXT_CONTENT_CONTAINER__CHILDREN;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == RichTextContentContainer.class) {
			switch (baseFeatureID) {
				case FxgPackage.RICH_TEXT_CONTENT_CONTAINER__CHILDREN: return FxgPackage.TCY__CHILDREN;
				default: return -1;
			}
		}
