 ...
 * <ul>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getId <em>Id</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getXml__base <em>Xml base</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getXml__lang <em>Xml lang</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getXml__space <em>Xml space</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getAlignment_baseline <em>Alignment baseline</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getBaseline_shift <em>Baseline shift</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getClip <em>Clip</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getClip_path <em>Clip path</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getClip_rule <em>Clip rule</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getColor <em>Color</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getColor_interpolation <em>Color interpolation</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getColor_interpolation_filters <em>Color interpolation filters</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getColor_profile <em>Color profile</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getColor_rendering <em>Color rendering</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getCursor <em>Cursor</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getDirection <em>Direction</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getDisplay <em>Display</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getDominant_baseline <em>Dominant baseline</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getEnable_background <em>Enable background</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getFill <em>Fill</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getFill_opacity <em>Fill opacity</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getFill_rule <em>Fill rule</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getFilter <em>Filter</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getFlood_color <em>Flood color</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getFlood_opacity <em>Flood opacity</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getFont_family <em>Font family</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getFont_size <em>Font size</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getFont_size_adjust <em>Font size adjust</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getFont_stretch <em>Font stretch</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getFont_style <em>Font style</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getFont_variant <em>Font variant</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getFont_weight <em>Font weight</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getGlyph_orientation_horizontal <em>Glyph orientation horizontal</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getGlyph_orientation_vertical <em>Glyph orientation vertical</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getImage_rendering <em>Image rendering</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getKerning <em>Kerning</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getLetter_spacing <em>Letter spacing</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getLighting_color <em>Lighting color</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getMarker_end <em>Marker end</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getMarker_mid <em>Marker mid</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getMarker_start <em>Marker start</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getMasks <em>Masks</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getOpacity <em>Opacity</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getOverflow <em>Overflow</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getPointer_events <em>Pointer events</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getShape_rendering <em>Shape rendering</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getStop_color <em>Stop color</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getStop_opacity <em>Stop opacity</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getStroke <em>Stroke</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getStroke_dasharray <em>Stroke dasharray</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getStroke_dashoffset <em>Stroke dashoffset</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getStroke_linecap <em>Stroke linecap</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getStroke_linejoin <em>Stroke linejoin</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getStroke_miterlimit <em>Stroke miterlimit</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getStroke_opacity <em>Stroke opacity</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getStroke_width <em>Stroke width</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getText_anchor <em>Text anchor</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getText_decoration <em>Text decoration</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getText_rendering <em>Text rendering</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getUnicode_bidi <em>Unicode bidi</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getWord_spacing <em>Word spacing</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getWriting_mode <em>Writing mode</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getX <em>X</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getY <em>Y</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getResult <em>Result</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getIn <em>In</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getIn2 <em>In2</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFeBlendElementImpl#getMode <em>Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
