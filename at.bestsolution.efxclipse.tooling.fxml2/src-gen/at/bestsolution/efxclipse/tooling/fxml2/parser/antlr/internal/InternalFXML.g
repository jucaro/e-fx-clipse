...
(
		lv_comments_1_0=RULE_ML_COMMENT
		{
...
(
		lv_comments_3_0=RULE_ML_COMMENT
		{
...
entryRuleXMLDec returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getXMLDecRule()); } 
	 iv_ruleXMLDec=ruleXMLDec 
	 { $current=$iv_ruleXMLDec.current.getText(); }  
	 EOF 
;

// Rule XMLDec
ruleXMLDec returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
...
entryRulePropertyAttributeDefinition returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getPropertyAttributeDefinitionRule()); }
	 ...
	 { $current=$iv_rulePropertyAttributeDefinition.current; } 
	 EOF 
;

// Rule PropertyAttributeDefinition
rulePropertyAttributeDefinition returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((
