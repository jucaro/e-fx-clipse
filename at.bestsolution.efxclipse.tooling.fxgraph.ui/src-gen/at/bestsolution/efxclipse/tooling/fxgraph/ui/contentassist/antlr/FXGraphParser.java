		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getElementAccess().getAlternatives_3_1_0(), "rule__Element__Alternatives_3_1_0");
					put(grammarAccess.getElementAccess().getAlternatives_3_1_1_1(), "rule__Element__Alternatives_3_1_1_1");
					...
					put(grammarAccess.getComponentDefinitionAccess().getGroup_4_3(), "rule__ComponentDefinition__Group_4_3__0");
					...
					put(grammarAccess.getElementAccess().getGroup_3_1_1(), "rule__Element__Group_3_1_1__0");
					...
					put(grammarAccess.getComponentDefinitionAccess().getControllerAssignment_3(), "rule__ComponentDefinition__ControllerAssignment_3");
					put(grammarAccess.getComponentDefinitionAccess().getCssFilesAssignment_4_2(), "rule__ComponentDefinition__CssFilesAssignment_4_2");
					put(grammarAccess.getComponentDefinitionAccess().getCssFilesAssignment_4_3_1(), "rule__ComponentDefinition__CssFilesAssignment_4_3_1");
					put(grammarAccess.getComponentDefinitionAccess().getPreviewResourceBundleAssignment_5_2(), "rule__ComponentDefinition__PreviewResourceBundleAssignment_5_2");
					...
					put(grammarAccess.getElementAccess().getPropertiesAssignment_3_1_0_0(), "rule__Element__PropertiesAssignment_3_1_0_0");
					put(grammarAccess.getElementAccess().getStaticPropertiesAssignment_3_1_0_1(), "rule__Element__StaticPropertiesAssignment_3_1_0_1");
					put(grammarAccess.getElementAccess().getPropertiesAssignment_3_1_1_1_0(), "rule__Element__PropertiesAssignment_3_1_1_1_0");
					put(grammarAccess.getElementAccess().getStaticPropertiesAssignment_3_1_1_1_1(), "rule__Element__StaticPropertiesAssignment_3_1_1_1_1");
					put(grammarAccess.getDefineAccess().getElementAssignment_1(), "rule__Define__ElementAssignment_1");
